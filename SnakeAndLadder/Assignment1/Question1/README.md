...
- Parses a raw line like: `name=Shlok;email=shlok@sst.edu;phone=9876543210;program=CSE`
...
```text
=== Student Onboarding ===
INPUT: name=Shlok;email=shlok@sst.edu;phone=9876543210;program=CSE
OK: created student SST-2026-0001
Saved. Total students: 1
CONFIRMATION:
StudentRecord{id='SST-2026-0001', name='Shlok', email='shlok@sst.edu', phone='9876543210', program='CSE'}

-- DB DUMP --
| ID             | NAME | PROGRAM |
| SST-2026-0001   | Shlok | CSE     |
```
